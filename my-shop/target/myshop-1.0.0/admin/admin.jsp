	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<div id="left_tab" style="margin-top: 70px;" class="collapse navbar-default navbar-collapse">
			<ul class="nav panel-group" id="myPanel">
				...
				<li class="panel">
					<a href="#sub3" data-toggle="collapse" data-parent="#myPanel"> 试题管理
						<span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
					</a>
					<ul id="sub3" class="nav panel-collapse collapse">
						<li>
							<a href="#" id="showGoodsType"> 
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看试题分类
							</a>
						</li>
						<li>
							<a href="#" id="addGoodsType"> 
								<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;添加试题分类
							</a>
						</li>
						<li>
							<a href="#" id="showGoods" > 
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看试题
							</a>
						</li>
						<li>
							<a href="#" id="addGoods"> 
				...
				<li class="panel">
					<a href="#sub2" data-toggle="collapse" data-parent="#myPanel"> 成绩管理
						<span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
					</a>
					<ul id="sub2" class="nav panel-collapse collapse">
						<li>
							<a href="#" id="showOrder"> 
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看成绩
							</a>
						</li>
					</ul>
				</li>
		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/showGoodsType.do");
				});

				$("#addGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/getGoodsType.do");
				});

				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/getGoodsList.do");
				});
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","addGoods.jsp");
				});
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/getAllOrder.do");
				});
			</script>
			<iframe class="dv_content" frameborder="0" scrolling="no" src="${pageContext.request.contextPath}/admin/getGoodsList.do">
